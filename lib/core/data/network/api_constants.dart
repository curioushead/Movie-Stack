...
class ApiConstants {
  ...
  // movies paths
  static String getNowPlayingMoviesPath(String region) =>
      '$baseUrl/movie/now_playing?api_key=$apiKey&region=$region';

  static String get popularMoviesPath =>
      '$baseUrl/movie/popular?api_key=$apiKey';

  static String get topRatedMoviesPath =>
