...
import 'package:movie_stack/core/presentation/components/custom_app_bar.dart';
import 'package:movie_stack/core/presentation/components/vertical_listview_card.dart';
import 'package:movie_stack/core/resources/app_strings.dart';

import 'package:movie_stack/core/presentation/components/vertical_listview.dart';
        ...
        body: BlocBuilder<PopularMoviesBloc, PopularMoviesState>(
          builder: (context, state) {
            switch (state.status) {
              ...
              case GetAllRequestStatus.fetchMoreLoading:
